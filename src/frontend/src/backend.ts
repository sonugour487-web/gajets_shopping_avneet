...
export class Backend implements backendInterface {
    ...
    async bulkAddProducts(arg0: Array<[string, string, bigint, bigint]>): Promise<Array<bigint>> {
        if (this.processError) {
            try {
                const result = await this.actor.bulkAddProducts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrder(arg0: Array<bigint>, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
